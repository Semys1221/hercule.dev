  ...
  return (
    <section id="pricing" className="relative py-40 px-6" style={{ backgroundColor: "#09090B" }}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          Un retour sur investissement rapide. Sans engagement contractuel.
        </motion.h2>
        ...
        >
          Cinq rendez-vous délivrés, un contrat signé à 4 000 € : pour un investissement de 1 489 €, le retour est
          positif dès la première signature.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">
              Cinq rendez-vous avec prospects qualifiés (300–800 € par lead). En l&apos;absence de signature, cinq
              nouveaux rendez-vous sont replanifiés.
            </p>
            <p className="text-zinc-500 text-sm">Première signature, risque maîtrisé.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">
              Jusqu&apos;à quatre signatures par mois. Hercule prend en charge l&apos;acquisition et les appels
              commerciaux.
            </p>
