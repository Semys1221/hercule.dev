...
import { Footer } from "@/components/cif/footer"
import { Navbar } from "@/components/cif/navbar"
    ...
    <div style={{ backgroundColor: "#09090B" }} className="min-h-screen">
      ...
      <main className="pt-28 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          <Link href="/conseil-financier" className="text-sm text-zinc-500 hover:text-zinc-300 transition-colors mb-8 inline-block">
