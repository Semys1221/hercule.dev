...
import { ApercuCrm } from "@/components/site/comptable/apercu-crm"
...
export function AccueilScene({ demandes, teaser }: AccueilSceneProps) {
  const copy = getMarketingCopy("assurance")
    ...
    <>
      <section className="relative min-h-screen overflow-hidden" style={{ backgroundColor: "#09090B" }}>
        ...
        <div className="relative z-10 pt-28 flex flex-col">
          ...
          <BandeStack audience="assurance" />
          <BandeProjets
            demandes={demandes}
            teaser={teaser}
            audience="assurance"
            bookingHref={CALENDLY_CIF_CONFERENCE_URL}
          />
          <PilierMatching audience="assurance" />
          <AuditLive audience="assurance" />
          <GrillePipeline demandes={demandes} audience="assurance" />
          <MethodeRadar audience="assurance" />
          <BlocGaranties audience="assurance" />
          <BandeAudit audience="assurance" bookingHref={CALENDLY_CIF_CONFERENCE_URL} />
          <Footer />
        </div>
      </section>
    </>
