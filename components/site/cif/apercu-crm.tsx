    ...
    >
      ...
      >
        ...
        <div className="p-4 space-y-3 flex-1">
          <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
            <p className="text-zinc-500 text-[10px] uppercase tracking-wider mb-1">Honoraires annuels</p>
      ...
      <motion.div className="flex-1 flex flex-col min-w-0" variants={panelVariants}>
        <div className="h-12 border-b border-zinc-800/50 flex items-center px-4 gap-4 shrink-0">
          <span className="text-white font-medium">Courtage de projets patrimoniaux</span>
  ...
  return (
    <div
      className={`p-2.5 rounded-md border bg-zinc-800/30 ${
        active ? "border-emerald-500/50 bg-emerald-500/5" : "border-zinc-800/80"
      }`}
    >
      <div className="flex items-start justify-between gap-2 mb-1">
        ...
        <span className="text-[10px] font-medium text-emerald-300 bg-emerald-500/20 px-1.5 py-0.5 rounded shrink-0">
          {budget}
        </span>
      </div>
  ...
  return (
    <div
      className={`px-2.5 py-2 rounded-md border ${
        variant === "hercule"
          ? "bg-emerald-500/10 border-emerald-500/20 ml-0 mr-4"
