        ...
        <div className="w-full max-w-5xl">
          ...
          >
            <div className="px-6 py-4 border-b border-border flex items-center gap-3">
              ...
              <span className="ml-auto text-xs text-muted-foreground bg-muted px-2 py-1 rounded">3 routés</span>
            </div>
            <div className="p-6 space-y-4">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50 border border-border/50">
                <Users className="size-4 text-amber-400 mt-0.5 shrink-0" />
                <div>
                  <p className="text-foreground text-sm font-medium">Sophie Martin · Resto Martin · Optimisation fiscale</p>
