      ...
      <AnimatePresence mode="wait">
        ...
        {step === 0 && (
          ...
          >
            <ChapterDoor
              label="GOOGLE ADS"
              icon={<Megaphone className="mb-1 size-5 text-muted-foreground" aria-hidden />}
            />
          </motion.div>
        )}
        ...
        {step === 1 && (
          ...
          >
            ...
            <PhoneIcon size={40} className="z-10 text-foreground" />
          </motion.div>
        )}
        ...
        {step === 2 && (
          ...
          >
            <div className="h-16 w-14 rounded-t border border-border border-b-0" />
        ...
        {step === 3 && (
          ...
          >
            ...
            <svg viewBox="0 0 120 80" className="h-20 w-40 text-muted-foreground" aria-hidden>
