...
export const COMPTABLE_OBJECTIFS_QUESTIONS: SalesQuestion[] = [
  {
    id: "b1",
    number: 1,
    sectionId: "objectifs",
    ...
    options: [
      { id: "more_dossiers", label: "Plus de dossiers (volume)" },
      { id: "better_quality", label: "Des dossiers de meilleure qualité (honoraires / typologie)" },
      { id: "monthly_growth", label: "Croissance mensuelle du récurrent" },
    ],
  },
  {
    id: "b2",
...
export const B3_YEAR_VALUES = B3_YEAR_MAP;
