...
const COMPTABLE_SALES_FUNNEL_SECTIONS: SalesFunnelSection[] = [
  ...
  },
  {
    ...
    title: "Conditions commerciales",
    subtitle:
      "Social / paie, missions ponctuelles, formules Hercule (Lite 1 799 €/mois, Starter 2 000 €/mois, pack 4 800 €) et priorités de dossiers.",
  },
];
...
const CIF_SALES_FUNNEL_SECTIONS: SalesFunnelSection[] = [
  ...
  },
  {
    ...
    title: "Conditions commerciales",
    subtitle:
      "Rémunération, missions ponctuelles, formules Hercule (Lite 1 799 €/mois, Starter 2 000 €/mois, pack 4 800 €) et priorités de mandats.",
  },
];
