...
import type { RecoveryDiagnostic, RecoveryPitchAngle } from "@/lib/legacy/dashboard/closing-recovery";
import type { ClosingCommitLevel, ClosingFitLevel } from "@/lib/legacy/dashboard/onboarding-faq";
