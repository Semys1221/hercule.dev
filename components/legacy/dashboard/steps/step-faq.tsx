...
import { getOnboardingFaq, onboardingFaqToDashboardItems } from "@/lib/legacy/dashboard/onboarding-faq";
import type { DashboardFaqAudience, DashboardFaqItem } from "@/lib/legacy/dashboard/types";
