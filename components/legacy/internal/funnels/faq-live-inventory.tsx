...
import { FaqEditor } from "@/components/legacy/internal/funnels/faq-editor";
...
} from "@/lib/legacy/admin/faq/live-registry";
                ...
                {selected.kind === "funnel_component" ? (
                  <Alert>
                    ...
                    <AlertDescription>
                      ...
                      <code>app/(marketing)/content/legal-documentation/{selected.audience}/faq.json</code>.
                    </AlertDescription>
                  </Alert>
                ) : null}
