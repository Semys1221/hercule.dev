...
import { PRODUCT_ROOT_LABEL } from "@/lib/legacy/admin/funnels/ui-copy";
import {
  MODULES,
  NICHE_LABELS,
  bookingsHref,
...
import { SEGMENT_LABELS } from "@/lib/legacy/admin/funnels/ui-copy";
import {
  isNiche,
  pathToHref,
  type NavNode,
} from "@/lib/legacy/admin/navigation";
import { getEmailSequence } from "@/lib/legacy/admin/email-sequences/registry";
