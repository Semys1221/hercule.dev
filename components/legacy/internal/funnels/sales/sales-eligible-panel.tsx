...
import { composeOpportunityCards } from "@/lib/legacy/admin/funnels/compose-opportunity-cards";
import type { ClientSegment } from "@/lib/legacy/admin/funnels/client-segment";
import { interpolateClientSegment } from "@/lib/legacy/admin/funnels/client-segment";
import {
  formatContractWindow,
  getAgencyPreset,
  type PresetOpportunityCard,
} from "@/lib/legacy/admin/funnels/sales-preset-registry";
import {
  scoreAgencyPresets,
  type AgencyPresetResult,
} from "@/lib/legacy/admin/funnels/sales-preset-scoring";
