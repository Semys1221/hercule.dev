...
import { isUpcomingBooking } from "@/lib/legacy/calendly/list-bookings";
import {
  buildSalesIntroChecklist,
  buildSalesIntroScript,
  extractSalesIntroFields,
  SALES_DECLARATIVE_SCRIPT,
} from "@/components/legacy/internal/funnels/sales/sales-intro-script";
import { parseSalesScriptBold } from "@/components/legacy/internal/funnels/sales/sales-script-content";
