...
} from "@/lib/legacy/admin/funnels/client-segment";
import type { Audience } from "@/lib/legacy/admin/navigation";
import { isCabinetBuyerSalesAudience, isCifSalesAudience, isComptableSalesAudience } from "@/lib/legacy/admin/funnels/sales-audience";
import {
  getSalesQuestions,
  formatSliderLabel,
  type SalesQuestion,
} from "@/components/legacy/internal/funnels/sales/sales-questions";
import { scoreAgencyPresets } from "@/lib/legacy/admin/funnels/sales-preset-scoring";
import {
...
import { SALES_SKIP_VALUE, type Q14Matrix, type SalesQualificationValues } from "@/lib/legacy/admin/funnels/sales-qualification-schema";
import type { LinkTrackingLead } from "@/lib/legacy/link-tracking/types";
import { resolveSalesSessionDashboardLink } from "@/lib/legacy/link-tracking/urls";
