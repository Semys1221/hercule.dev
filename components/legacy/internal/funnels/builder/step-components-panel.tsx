...
import { FaqWidgetStack } from "@/components/legacy/funnels/funnel-widgets/faq-widget-stack";
import { PricingWidget } from "@/components/legacy/funnels/funnel-widgets/pricing-widget";
import { FaqPreviewAccordion } from "@/components/legacy/internal/funnels/faq-preview-accordion";
...
import type {
  ...
  FunnelStep,
  StepComponents,
} from "@/lib/legacy/admin/funnels/schema";
          ...
          <FieldSet>
            <FieldGroup>
              <Field>
                ...
                <FieldDescription>
                  Les ajouts permanents mettent à jour <code>app/(marketing)/content/legal-documentation/{scope.audience}/faq.json</code>
                  .
                </FieldDescription>
              </Field>
              <Field>
