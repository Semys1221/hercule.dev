...
import { InternalResourceToolbar } from "@/components/legacy/internal/funnels/ui/internal-resource-toolbar";
import { funnelApiUrl } from "@/lib/legacy/admin/funnels/client";
import { funnelListHref } from "@/lib/legacy/admin/funnels/routing";
import { funnelToolbarActions } from "@/lib/legacy/admin/funnels/toolbar-actions";
import type { FunnelDocument, FunnelScope } from "@/lib/legacy/admin/funnels/schema";
import { PARCOURS_DELETE_WARNING } from "@/lib/legacy/admin/funnels/ui-copy";
