/**
 * Export Notion canon → content/legal-documentation + sanity check constants.
 *
 * Notion DB Offres is the editorial master. This script documents the sync contract
 * and re-asserts that content/ mirrors canon pricing v3
...
import { LEGAL_DOCUMENTATION_ROOT, getSharedCvgMarkdownPath } from "@/lib/legal-documentation/paths";
...
console.log("exportLegal.ts: content/legal-documentation mirrors Notion canon v3");
