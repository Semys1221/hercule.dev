# Conditions Générales de Vente — Hercule CIF
...
> **Version :** 2026-09-10  
> **Documents associés :** [cvg_master.md](./cvg_master.md) · [constants-commercial.md](./constants-commercial.md) · [ai-reply-knowledge-cif.md](./ai-reply-knowledge-cif.md)  
...
Cabinet CIF / CGP professionnel (B2B) souscrivant aux formules Hercule CIF, comptant **plus de 3 associés ou collaborateurs**, agissant dans le cadre de son activité et disposant de la capacité juridique pour contracter.

---

## 2. Champ d'application

Les présentes CGV s'appliquent à toute commande ou souscription aux prestations Hercule CIF proposées au Client (cabinet partenaire).
...
| **Mission** | Contrat annuel de optimisation fiscale et trésorerie et fiscale que le cabinet peut proposer au dirigeant rencontré via Hercule. |
...
Hercule fournit un service de **mise en relation B2B** entre des indépendants et dirigeants de TPE ayant un besoin de accompagnement patrimonial, fiscale et administrative, et des cabinets CIF / CGP partenaires éligibles.
