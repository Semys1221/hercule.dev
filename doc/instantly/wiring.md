...
|-------------|----------------|---------------------|
| `restaurants.md` | `restaurants_independants` | Restaurants (DCE) — `e4f11e76-717e-4be9-a6ad-c7f0a331afb7` · parallèle V2 — `2102110d-1491-4bd0-aa24-cfd29e9a0218` (E1 marge + RDV, délai 5 min) |
