import type { SmokeRequestContext } from "./http-request";

import { deleteSeedClient, isSeedSlug } from "@/lib/legacy/admin/clients/seed";
...
export async function assertServerReachable(request: SmokeRequestContext): Promise<void> {
...
export async function cleanupSalesSession(request: SmokeRequestContext): Promise<void> {
...
export async function provisionSalesSession(request: SmokeRequestContext): Promise<void> {
...
export async function seedDemoClients(request: SmokeRequestContext): Promise<void> {
...
export async function skipPayment(request: SmokeRequestContext, slug: string): Promise<void> {
...
export async function completeOnboardingApi(request: SmokeRequestContext, slug: string): Promise<void> {
...
export async function bootstrapDryRunClient(request: SmokeRequestContext): Promise<void> {
...
export async function bootstrapLiveRunClient(request: SmokeRequestContext): Promise<void> {
  await cleanupSalesSession(request);
  await provisionSalesSession(request);
  await seedDemoClients(request);
}

export async function createAcmeMatchWithAppointment(request: SmokeRequestContext): Promise<{
  matchId: string;
...
export async function createBravoMatchWithAppointment(request: SmokeRequestContext): Promise<{
  matchId: string;
  appointmentId: string;
}> {
...
export async function triggerBookingEmailsCron(request: SmokeRequestContext): Promise<void> {
