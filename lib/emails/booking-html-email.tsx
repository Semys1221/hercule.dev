...
import { signatureTagline } from "@/lib/legacy/booking-communication/signatures";
import type { LeadCategory } from "@/lib/legacy/link-tracking/types";
import type { MeetingActionLinks } from "@/lib/legacy/booking-communication/meeting-links";
...
export function BookingHtmlEmail({
  ...
  confirmButtonLabel = "Confirmer ma présence",
  meetingActionLinks,
  signatureTagline: signatureTaglineProp,
  ...
  return (
    <BookingEmailLayout
      preview={preview}
      signatureTagline={signatureTaglineProp ?? signatureTagline(category)}
      meetingActionLinks={meetingActionLinks}
    >
