...
export const FAQ_LIVE_INSTANCES: FaqLiveInstance[] = [
  {
    ...
    audience: "agence",
    kind: "master",
    sourcePath: "app/(marketing)/content/legal-documentation/agence/faq.json",
  },
  {
    ...
    audience: "entreprise",
    kind: "master",
    sourcePath: "app/(marketing)/content/legal-documentation/entreprise/faq.json",
  },
  {
    id: "master-comptable",
    ...
    audience: "comptable",
    kind: "master",
    sourcePath: "app/(marketing)/content/legal-documentation/comptable/faq.json",
  },
  {
    id: "funnel-faq-widget-comptable",
    name: "Widget FAQ funnel agence",
    title: "Blocs FAQ des étapes funnel agence",
    location: "components/legacy/funnels/funnel-widgets/faq-widget.tsx",
    audience: "agence",
    kind: "funnel_component",
    sourcePath: "components/legacy/funnels/funnel-widgets/faq-widget.tsx",
  },
  {
