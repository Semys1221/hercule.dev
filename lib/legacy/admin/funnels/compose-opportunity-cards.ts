...
} from "@/lib/legacy/admin/funnels/opportunity-card-blueprints";
...
import {
  ...
  type BudgetKind,
} from "@/lib/legacy/admin/funnels/opportunity-card-formulas";
import type { PresetOpportunityCard } from "@/lib/legacy/admin/funnels/sales-preset-registry";
