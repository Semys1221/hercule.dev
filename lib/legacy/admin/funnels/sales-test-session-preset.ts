import { SLIDER_CONFIGS } from "@/components/legacy/internal/funnels/sales/sales-questions";
import { COMPTABLE_SLIDER_CONFIGS } from "@/components/legacy/internal/funnels/sales/sales-questions-comptable";
import { CIF_SLIDER_CONFIGS } from "@/components/legacy/internal/funnels/sales/sales-questions-cif";
import type { SalesClosingValues } from "@/components/legacy/internal/funnels/sales/sales-closing-sections";
import { SEED_PREFIX } from "@/lib/legacy/admin/clients/seed";
import {
  SALES_SKIP_VALUE,
...
import { isComptableSalesAudience } from "@/lib/legacy/admin/funnels/sales-audience";
import type { LeadCategory } from "@/lib/legacy/link-tracking/types";
import type { DashboardFormData } from "@/lib/legacy/dashboard/types";
