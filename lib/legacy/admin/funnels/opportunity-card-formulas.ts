import { HERCULE_MONTHLY_MIN } from "@/components/legacy/internal/funnels/sales/sales-questions";
import { COMPTABLE_ANNUAL_MIN } from "@/components/legacy/internal/funnels/sales/sales-questions-comptable";
import { CIF_ANNUAL_MIN } from "@/components/legacy/internal/funnels/sales/sales-questions-cif";
import type { Audience } from "@/lib/legacy/admin/navigation";
import {
  isCabinetBuyerSalesAudience,
  isCifSalesAudience,
  isComptableSalesAudience,
} from "@/lib/legacy/admin/funnels/sales-audience";
import type { AgencyPresetId } from "@/lib/legacy/admin/funnels/sales-preset-scoring";
