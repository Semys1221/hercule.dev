...
} from "@/lib/legacy/admin/funnels/compose-opportunity-cards";
import {
...
import { SALES_TEST_SESSION_QUALIFICATION } from "@/lib/legacy/admin/funnels/sales-test-session-preset";
import {
  AGENCY_PRESET_IDS,
  type AgencyPresetId,
  scoreAgency,
