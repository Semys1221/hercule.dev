...
import { CIF_DIFFERENTIATOR_OPTIONS } from "@/lib/legacy/admin/funnels/cif-sales-copy";
import {
  isCabinetBuyerSalesAudience,
  isCifSalesAudience,
} from "@/lib/legacy/admin/funnels/sales-audience";
import { interpolateClientSegment, type ClientSegment } from "@/lib/legacy/admin/funnels/client-segment";
...
function getObjectifsQuestions(audience: Audience): SalesQuestion[] {
  ...
  const { getWizardObjectifsQuestions } =
    require("@/components/legacy/internal/funnels/sales/sales-questions-objectifs-wizard") as {
