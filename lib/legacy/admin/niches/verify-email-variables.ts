...
} from "@/lib/legacy/admin/niches/live-sequence-variables";
...
} from "@/lib/legacy/admin/niches/variable-resolution";
import { formatVariableToken } from "@/lib/legacy/admin/email-sequences/extract-variables";
import { fetchLeadsFromCampaign, getInstantlyApiKey } from "@/lib/instantly";
import { normalizeEmail, createLinkTrackingClient } from "@/lib/legacy/link-tracking/supabase";
