import { DEFAULT_BOOKING_EMAIL_TEMPLATES } from "@/lib/legacy/booking-communication/templates";
import type { BookingEmailType } from "@/lib/legacy/booking-communication/types";

import type { DeliveranceAction } from "@/lib/legacy/deliverance/orchestrator";
