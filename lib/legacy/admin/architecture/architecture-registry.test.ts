...
import { COMPONENTS_REGISTRY } from "@/lib/legacy/admin/architecture/components-registry";
import { DATABASE_REGISTRY } from "@/lib/legacy/admin/architecture/database-registry";
import {
...
const componentsDocPath = join(
  process.cwd(),
  "app/(legacy)/content/tech/06-components.md",
);
