...
import { getComptableAcquisition1489PriceId } from "@/lib/legacy/payments/stripe";
...
/**
 * Default Payment Link URL (provision via lib/lib/backend/scripts/crm/provisionComptableAcquisition1489Stripe.ts).
