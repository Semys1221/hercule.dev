...
import { getHerculeLiberalPriceId } from "@/lib/legacy/payments/stripe";
...
/**
 * Default Payment Link URL (provision via lib/lib/backend/scripts/crm/provisionHerculeLiberalStripe.ts).
