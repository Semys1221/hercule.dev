...
import { isCampaignLeadAlreadyBooked } from "@/lib/legacy/link-tracking/split-booking";
...
async function closePipelineLead(params: {
  ...
  await upsertPipelineStep(campaignId, leadEmail, "step_4");
  const { syncPipelineClosed } = await import("@/lib/legacy/admin/management/recipients/hooks");
