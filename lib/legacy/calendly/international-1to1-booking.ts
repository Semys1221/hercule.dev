import { createSingleUseSchedulingLink } from "@/lib/legacy/calendly/create-single-use-link";
import { getInternational1to1EventTypeUri } from "@/lib/legacy/calendly/availability";
import {
  canIssueInternational1to1Link,
  inboundLooksLikeInternationalLead,
} from "@/lib/legacy/ai-reply-agent/international-inbound";
