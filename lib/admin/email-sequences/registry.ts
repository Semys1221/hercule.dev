...
const EMAIL_SEQUENCES: EmailSequenceEntry[] = [
  ...
  },
  {
    ...
    audiences: ["comptable"],
    description:
      "Nurture manuelle Clients → Séquences. E1–E3 à J+1/J+2/J+3. Stop si reply/opt-out ou checkout trial (monthly_1499_trial). Pitch : premier RDV visio offert + essai 14j puis 1 499 €/mois.",
    steps: [
      {
        id: "free_trial_1",
  ...
  },
  {
    ...
    audiences: ["comptable"],
    description:
      "Déclenchée par Stripe checkout monthly_1499_trial (metadata product=free_trial). Remplace payment-welcome pour cette offre. E1 immédiat, E2 J+2, E3 J+3. Lien portail pour désabonnement.",
    steps: [
      {
