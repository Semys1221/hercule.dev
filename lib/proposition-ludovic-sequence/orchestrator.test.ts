...
vi.mock("@/lib/link-tracking/supabase", () => ({
...
vi.mock("@/lib/booking-communication/product-send", () => ({
...
// ─── Mock hooks ───────────────────────────────────────────────────────────────
vi.mock("@/lib/admin/management/recipients/hooks", () => ({
  syncClientSequenceStarted: vi.fn(),
}));

// ─── Mock urls ────────────────────────────────────────────────────────────────
vi.mock("@/lib/link-tracking/urls", () => ({
