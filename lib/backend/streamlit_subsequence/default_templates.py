...
JUM_TEMPLATE_BODIES: dict[str, str] = {
    "interested_email1_restaurant": """<p>L'étude prend environ 20 minutes.<br/><br/>Vous saurez directement à l'issue s'il vous est possible de ne plus avoir à avancer les frais vous-même pour payer vos fournisseurs.<br/><br/>Si cela est accessible à votre situation, nous vous expliquerons ensuite les possibilités adaptées.<br/><br/>Vous pouvez choisir directement un créneau ici : <a href="https://www.hercule.dev/reservation/restaurant.html">Choisir un créneau</a><br/><br/>Béatrice Meyer</p>""",
