...
JUM_TEMPLATE_BODIES: dict[str, str] = {
    "interested_email1_restaurant": """<p>Il nous reste actuellement 3 créneaux pour de nouveaux établissements.<br/><br/>Vous pouvez simplement vérifier si votre restaurant est éligible ici :<br/><br/><a href="https://www.hercule.dev/reservation/restaurant.html">Vérifier mon éligibilité →</a><br/><br/>Bien à vous,</p>""",
