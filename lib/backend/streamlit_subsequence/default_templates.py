...
JUM_TEMPLATE_BODIES: dict[str, str] = {
    "interested_email1_restaurant": """<p>Voici plus de précisions.<br/><br/>Le plus souvent, vous savez combien votre restaurant gagne. Mais vous ignorez précisément où il perd de l'argent.<br/><br/>En 30 minutes, nous pouvons identifier les principales sources de perte — achats, plats peu rentables, coûts de personnel — et les leviers rapides à corriger pour récupérer de la marge.<br/><br/>Vous pouvez choisir directement un créneau ici : <a href="{{reservation_jum_link}}">Choisir un créneau</a><br/><br/>Béatrice Meyer</p>""",
