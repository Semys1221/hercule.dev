...
JUM_TEMPLATE_BODIES: dict[str, str] = {
    "interested_email1_restaurant": """<p>Nous avons encore 3 ouvertures pour de nouveaux établissements.<br/><br/>Je vous laisse vérifier si votre restaurant peut entrer dans le dispositif :<br/><br/><a href="https://www.hercule.dev/reservation/restaurant.html">Vérifier mon établissement</a></p>""",
