...
import { buildMeniaudSerialQualification } from "@/lib/legacy/admin/bookings/meniaud-serial-qualification";
...
import { renderEmailFromStore } from "@/lib/legacy/booking-communication/template-store";
