...
import { buildEntrepriseLeadUrls, buildLeadUrls, buildInstantlyCustomVariables } from "@/lib/legacy/link-tracking/urls";
import { DEFAULT_BOOKING_EMAIL_TEMPLATES, renderTemplate } from "@/lib/legacy/booking-communication/templates";
