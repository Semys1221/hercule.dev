...
E1_BODY = f"""<p>Nous accompagnons des restaurants indépendants qui travaillent beaucoup mais qui constatent qu'il reste parfois trop peu à la fin du mois.<br/><br/>Concrètement, nous prenons en charge 3 points :<br/><br/><ul><li><strong>Achats fournisseurs</strong> : nous contrôlons vos prix fournisseurs et le coût réel de vos plats.</li><li><strong>Plats peu rentables</strong> : nous recalculons leur coût réel pour identifier les prix à ajuster ou les plats à modifier.</li><li><strong>Personnel</strong> : nous analysons vos heures, vos plannings et vos coûts pour repérer ce qui pèse inutilement sur votre marge.</li></ul><br/>Vous n'avez pas à analyser ces chiffres vous-même : nous prenons en charge ce pilotage chaque mois ou chaque semaine.<br/><br/>Après entretien, les établissements éligibles peuvent bénéficier d'un potentiel allant jusqu'à 2 500 € de marge nette supplémentaire par mois.<br/><br/>Si vous souhaitez que nous regardions votre établissement, vous pouvez choisir un créneau ici : {CTA}<br/><br/>Béatrice Meyer</p>"""

E2_BODY = f"""<p>Bonjour,<br/><br/>Un restaurant peut avoir une bonne activité tout en laissant trop peu de bénéfice à la fin du mois.<br/><br/>C'est précisément ce que nous cherchons à identifier : achats trop élevés, plats peu rentables, coûts de personnel…<br/><br/>Si vous souhaitez que nous regardions votre situation, vous pouvez choisir un créneau ici : {CTA}{OPT_OUT}<br/><br/>Béatrice Meyer</p>"""
