...
# Load env files explicitly (lib/backend/crm/.env overrides repo root .env)
...
class Settings(BaseSettings):
    ...
    tracking_base_url_agence: str = "https://www.hercule.dev/reservation"
    tracking_base_url_entreprise: str = "https://www.hercule.dev/reservation"
