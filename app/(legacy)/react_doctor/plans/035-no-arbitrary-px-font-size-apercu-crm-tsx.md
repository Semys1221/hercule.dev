# 035 — Fix no-arbitrary-px-font-size in components/agence/apercu-crm.tsx
...
Location: `components/agence/apercu-crm.tsx:192`
...
1. Open `components/agence/apercu-crm.tsx` at line 192.
...
- **Done when**: diagnostic at `components/agence/apercu-crm.tsx:192` is resolved.
