# 018 — Fix hercule/space-axis-in-internal in components/internal/funnels/email-sequences-table.tsx
...
Location: `components/internal/funnels/email-sequences-table.tsx:70`
...
1. Open `components/internal/funnels/email-sequences-table.tsx` at line 70.
...
- **Done when**: diagnostic at `components/internal/funnels/email-sequences-table.tsx:70` is resolved.
