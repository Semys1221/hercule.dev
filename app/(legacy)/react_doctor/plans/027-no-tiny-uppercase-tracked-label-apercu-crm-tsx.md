# 027 — Fix no-tiny-uppercase-tracked-label in components/agence/apercu-crm.tsx
...
Location: `components/agence/apercu-crm.tsx:156`
...
1. Open `components/agence/apercu-crm.tsx` at line 156.
...
- **Done when**: diagnostic at `components/agence/apercu-crm.tsx:156` is resolved.
