# 030 — Fix no-tiny-uppercase-tracked-label in components/comptable/carte-projet.tsx
...
Location: `components/comptable/carte-projet.tsx:21`
...
1. Open `components/comptable/carte-projet.tsx` at line 21.
...
- **Done when**: diagnostic at `components/comptable/carte-projet.tsx:21` is resolved.
