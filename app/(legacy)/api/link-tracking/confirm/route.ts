...
import { cancelFollowUpJobs } from "@/lib/legacy/booking-communication/jobs";
import { ensureLeadBookedBeforeConfirm } from "@/lib/legacy/link-tracking/book-lead";
import { syncLeadConfirmedToInstantly } from "@/lib/legacy/link-tracking/instantly";
import {
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { syncLeadConfirmed } = await import("@/lib/legacy/admin/management/recipients/hooks");
    syncLeadConfirmed({
