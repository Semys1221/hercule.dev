...
} from "@/lib/legacy/payments/comptable-offers";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (stripeAmountCents !== amountCents) {
      console.error(
        "[payments/checkout-cif] Unexpected Stripe price amount:",
        priceId,
        stripeAmountCents,
        "expected",
        amountCents,
    ...
    fetch("http://127.0.0.1:7849/ingest/172cb84e-a8e1-4d83-b273-2b61310f5e7d", {
      ...
      body: JSON.stringify({
        ...
        runId: "post-fix",
        hypothesisId: "A-B",
        location: "checkout-cif/route.ts:priceResolved",
    ...
    fetch("http://127.0.0.1:7849/ingest/172cb84e-a8e1-4d83-b273-2b61310f5e7d", {
      ...
      body: JSON.stringify({
        ...
        runId: "post-fix",
        hypothesisId: "A-B",
        location: "checkout-cif/route.ts:success",
        message: "CIF checkout session created",
        data: {
          slug,
          offerType,
          checkoutMode,
    ...
    fetch("http://127.0.0.1:7849/ingest/172cb84e-a8e1-4d83-b273-2b61310f5e7d", {
      ...
      body: JSON.stringify({
        ...
        runId: "post-fix",
        hypothesisId: "A-E",
        location: "checkout-cif/route.ts:catch",
        message: "CIF checkout failed",
