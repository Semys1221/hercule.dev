...
function listId(): string {
  return process.env.VETERINAIRES_LIST_ID?.trim() || vertical.listId;
}
...
/**
 * Instantly email_sent → provision JUM reservation links for vétérinaires.
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("[webhooks/instantly/provision-jum-veterinaire]", message);
    return NextResponse.json({
      ok: true,
