...
function listId(): string {
  return process.env.ARCHITECTES_DPLG_LIST_ID?.trim() || vertical.listId;
}
...
/**
 * Instantly email_sent → provision JUM reservation links for architectes DPLG.
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("[webhooks/instantly/provision-jum-architecte]", message);
    return NextResponse.json({
      ok: true,
