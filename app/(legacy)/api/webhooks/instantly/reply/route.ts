...
import { isInstantlyWebhookAuthorized } from "@/lib/legacy/ai-reply-agent/auth";
import { isHandledReplyAgentEvent } from "@/lib/legacy/ai-reply-agent/events";
import { handleInstantlyReply } from "@/lib/legacy/ai-reply-agent/handler";

import type { InstantlyReplyWebhookPayload } from "@/lib/legacy/ai-reply-agent/types";
