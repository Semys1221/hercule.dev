...
import { cancelConferenceInviteJobs, cancelFollowUpJobs } from "@/lib/legacy/booking-communication/jobs";
...
async function handleInviteeCanceled(payload: unknown) {
  ...
  const { syncCalendlyCancelled } = await import("@/lib/legacy/admin/management/recipients/hooks");
