...
} from "@/lib/legacy/dashboard/payments";
import { loadDeliveryContext } from "@/lib/legacy/dashboard/load-delivery-context";
import { loadSaasDashboardKpi } from "@/lib/legacy/dashboard/load-saas-kpi";
import { buildDashboardBleedContext } from "@/lib/legacy/dashboard/bleed-context";
import { isFormSparse, resolvePreviewForm } from "@/lib/legacy/dashboard/resolve-preview-form";
import { ensureSalesTestSessionLead } from "@/lib/legacy/admin/funnels/ensure-sales-test-session";
...
import { isLegacyComptableEntrepriseLead } from "@/lib/legacy/dashboard/legacy-comptable-entreprise";
import {
  completeBuyerOnboarding,
  waiveRetractionNow,
} from "@/lib/legacy/dashboard/onboarding-complete";
import { buildComptableNotPaidMilestones } from "@/lib/legacy/dashboard/comptable-not-paid-milestones";
import { buildDashboardRetractionFields } from "@/lib/legacy/dashboard/retraction-fields";
import { mergeDashboardClosing, parseDashboardClosing } from "@/lib/legacy/dashboard/closing-state";
import type {
