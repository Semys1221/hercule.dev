...
| streamlit-demands | component | marketing | `lib/backend/streamlit_demands/app.py` |
| streamlit-scraper | component | crm | `lib/backend/streamlit_scraper/app.py` |
| streamlit-clean | component | crm | `lib/backend/streamlit_clean/app.py` |
...
| streamlit-links | component | dashboard_internal | `lib/backend/streamlit_links/app.py` |
| streamlit-booking-resend | component | dashboard_internal | `lib/backend/streamlit_booking_resend/app.py` |
| streamlit-subsequence | component | communication | `lib/backend/streamlit_subsequence/app.py` |
| streamlit-reply-agent | component | communication | `lib/backend/streamlit_reply_agent/app.py` |
| streamlit-stats | component | sales_funnel | `lib/backend/streamlit_stats/app.py` |
