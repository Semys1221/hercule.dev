# Archive — documentation pré-architecture (2026-09)

```
status: archived
audience: human
do_not:
  - Implémenter quoi que ce soit depuis ce dossier
```
...
Ne pas restaurer ces fichiers dans `doc/tech-stack/` sans revue d’architecture.
